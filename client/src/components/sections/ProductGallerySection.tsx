  ...
  const productPages = [
    {
      id: '1',
      title: '首頁',
      description: '協同代理的入口，直觀展示產品的核心價值。用戶在此輸入日常糾結命題後，系統將自動啟動並引導完成四階人機協同工作流。',
    ...
    },
    {
      id: '2',
      title: '指標加權與標籤池',
      description: '系統透過 useState 管理即時狀態，將 AI 提取的利弊標籤轉化為動態滑桿，讓使用者能直覺調整各項因素對最終決策的影響權重。',
    ...
    },
    {
      id: '3',
      title: 'AI 決策反饋面板',
      description: '核心引擎調度 Gemini API 進行交叉比對，主動扮演「反方挑戰者」揭露人類當局者迷的專案風險，並結合信心指數評估，給出具體且符合邏輯的行動替代方案。',
    ...
    },
    {
      id: '4',
      title: 'ICE 決策沙盒',
      description: '引入敏捷開發標準的 ICE 模型，利用 useMemo 即時運算綜合決策分數，並自動生成最高風險警示與 Plan B 應變計畫，將模糊的直覺轉化為清晰、可參考的量化方案。',
