...
export default function ReflectionSection() {
  const reflections = [
    {
      title: '從基礎到可用的跨越',
      description: '在 Vibe Coding 時代，傳統的程式語法壁壘已被打破。我透過正確調度 Lovable、GitHub 與本機開發環境，在短時間內迅速落地了這套AI 決策系統，驗證了現代AI工具鏈的極致交付效率。',
      icon: '1',
      color: 'from-orange-50 to-amber-50',
    },
    {
      title: '思維的終極轉型',
      description: '此專案深化了我對技術研發的認知。程式碼編寫細節已可全權委派給 AI，而開發者的核心價值，徹底轉變為「對複雜問題的拆解能力、底層系統架構的整體規劃、以及人機協作流程的邊界設計」。',
      icon: '2',
      color: 'from-slate-50 to-gray-50',
    },
    {
      title: 'AI 協作新範式',
      description: '這場實踐並非讓 AI 盲目替代人工，而是將其作為大腦的思維延伸。我負責主導系統的架構設計與核心決策因果，將繁瑣的程式碼實作與除錯細節交由 LLM 執行，實現高效的協作。',
      icon: '3',
      color: 'from-slate-50 to-gray-50',
    },
    {
      title: '持續進化的起點',
      description: '從模糊點子到網頁上線，每一次的 Prompt 調整與程式碼迭代，都是用工具實現想法的過程。我在此專案中確立了新時代的開發者定位：不被特定工具定義，而是具備駕馭多模型協作、驅動產品落地的全局架構思維。',
      icon: '4',
      color: 'from-orange-50 to-amber-50',
    },
  ];
